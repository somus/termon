...
var RosterOrder = []string{
	...
	"splashlotl", "cachelotl", "rebootide",
	"zaplet", "voltalon", "stormkernel",
	"joulepup", "voltweiler", "ampmastiff",
	"ampcoil", "coilobra", "gridaconda",
	"surgetail", "stormfin", "tempestray",
	"spamlet", "mailgnant", "phishmonger",
	"bloatware", "bloatmass", "heapocalypse",
	"wormate", "segmaggot", "hexwurm",
	"chippunk", "solderat", "rackoon",
	"coghound", "trackhound", "watchdaemon",
