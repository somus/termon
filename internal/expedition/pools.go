...
var supportPools = map[string][]string{
	...
	"mossmuff":   {"taproot", "emberbyte"},
	"taproot":    {"rootkit", "emberbyte"},
	...
	"gushkit":    {"splashlotl", "rootkit"},
	"mistcache":  {"flowcell", "rootkit"},
	"splashlotl": {"aquabit", "rootkit"},
	"zaplet":     {"joulepup", "spamlet"},
	"joulepup":   {"ampcoil", "spamlet"},
	"ampcoil":    {"surgetail", "spamlet"},
...
var supportThemes = map[string]string{
	...
	"taproot":   "organic siblings · thermal counterplay",
	...
	"splashlotl": "coolant siblings · organic counterplay",
	"zaplet":     "current siblings · virus counterplay", "joulepup": "current siblings · virus counterplay",
	"ampcoil": "current siblings · virus counterplay", "surgetail": "current siblings · virus counterplay",
