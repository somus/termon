...
var identity = map[string]objectiveID{
	...
	"splashlotl": holdTheLine,
	"zaplet":     measuredPressure,
	"joulepup":   measuredPressure,
	"ampcoil":    holdTheLine,
...
var referenceTeams = [][]string{
	...
	{"taproot", "flowcell", "bloatware"},
	{"sproutware", "wickware", "mistcache"},
	{"thornpatch", "gushkit", "joulepup"},
	{"cindernode", "ampcoil", "coghound"},
	{"mossmuff", "splashlotl", "surgetail"},
